...
\textbf{График:} & Рисунок \ref{TestFunctions:img:HML_TestFunction_Ackley_Graph} нас \pageref{TestFunctions:img:HML_TestFunction_Ackley_Graph} стр.   \\
\end{tabularwide}

\begin{figure} [h] 
  \center
  \includegraphics [scale=0.5] {HML_TestFunction_Ackley_Graph}
  \caption{Функция Ackley} 
  \label{TestFunctions:img:HML_TestFunction_Ackley_Graph}  
\end{figure}
