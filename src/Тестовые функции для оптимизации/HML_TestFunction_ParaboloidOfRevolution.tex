...
\textbf{График:} & Рисунок \ref{TestFunctions:img:HML_TestFunction_ParaboloidOfRevolution_Graph} нас \pageref{TestFunctions:img:HML_TestFunction_ParaboloidOfRevolution_Graph} стр.   \\
\end{tabularwide}

\begin{figure} [h] 
  \center
  \includegraphics [scale=0.5] {HML_TestFunction_ParaboloidOfRevolution_Graph}
  \caption{Эллиптический параболоид} 
  \label{TestFunctions:img:HML_TestFunction_ParaboloidOfRevolution_Graph}  
\end{figure}
