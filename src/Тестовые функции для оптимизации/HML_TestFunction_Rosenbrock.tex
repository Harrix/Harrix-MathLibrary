...
\textbf{График:} & Рисунок \ref{TestFunctions:img:HML_TestFunction_Rosenbrock_Graph} нас \pageref{TestFunctions:img:HML_TestFunction_Rosenbrock_Graph} стр.   \\
\end{tabularwide}

\begin{figure} [h] 
  \center
  \includegraphics [scale=0.5] {HML_TestFunction_Rosenbrock_Graph}
  \caption{Функция Розенброка} 
  \label{TestFunctions:img:HML_TestFunction_Rosenbrock_Graph}  
\end{figure}
