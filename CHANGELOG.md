...
4.1
----
 * Функций в библиотеке 375 функций (собственных).
 * Добавлены новые функции. 
 * Добавлены переопределенные функции.
 
4.0
----
 * Все функции шаблоны начинались с TMHL_. Теперь они все начинаются с HML_.
 * Все функции шаблоны начинались с MHL_. Теперь они все начинаются с HML_. То есть Функции и шаблоны-функции начинаются одинаково.
 * Обновлены сопутствующие библиотеки и стилевые файлы.
 * Добавлена функция-перегрузка для HML_WilcoxonW.
 * Обновлена программа MakeHarrixMathLibrary

3.79
----
 * Функций в библиотеке 353 функций (собственных).

3.78
----
 * Функций в библиотеке 347 функций (собственных).

3.77
----
 * Функций в библиотеке 341 функций (собственных).
 * В справке появились ссылки на упоминаемые функции.
 * Обновилась версия MakeHarrixMathLibrary.exe.

3.76
----
 * Функций в библиотеке 338 функций (собственных).
 * Исправлена справка некоторых функций.
 * Обновилась версия MakeHarrixMathLibrary.exe до второй версии: появились несколько нужных кнопок-функций.

3.75
----
 * Добавлены функции, так что теперь теперь в библиотеке 335 функций (собственных).
 * Добавлен новый раздел функций «Физика».
 ...
 * Некоторые исправления в справках некоторых функций.
