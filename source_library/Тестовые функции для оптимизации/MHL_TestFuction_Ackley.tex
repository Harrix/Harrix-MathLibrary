...
\textbf{График:} & Рисунок \ref{TestFunctions:img:MHL_TestFuction_Ackley_Graph} нас \pageref{TestFunctions:img:MHL_TestFuction_Ackley_Graph} стр.   \\
\end{tabularwide}

\begin{figure} [h] 
  \center
  \includegraphics [scale=0.5] {MHL_TestFuction_Ackley_Graph}
  \caption{Функция Ackley} 
  \label{TestFunctions:img:MHL_TestFuction_Ackley_Graph}  
\end{figure}
