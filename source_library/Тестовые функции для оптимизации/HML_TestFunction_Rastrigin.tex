...
\textbf{График:} & Рисунок \ref{TestFunctions:img:HML_TestFunction_Rastrigin_Graph} нас \pageref{TestFunctions:img:HML_TestFunction_Rastrigin_Graph} стр.   \\
\end{tabularwide}

\begin{figure} [h] 
  \center
  \includegraphics [scale=0.5] {HML_TestFunction_Rastrigin_Graph}
  \caption{Функция Растригина} 
  \label{TestFunctions:img:HML_TestFunction_Rastrigin_Graph}  
\end{figure}
