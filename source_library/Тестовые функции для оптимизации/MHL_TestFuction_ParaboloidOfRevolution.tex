...
\textbf{График:} & Рисунок \ref{TestFunctions:img:MHL_TestFuction_ParaboloidOfRevolution_Graph} нас \pageref{TestFunctions:img:MHL_TestFuction_ParaboloidOfRevolution_Graph} стр.   \\
\end{tabularwide}

\begin{figure} [h] 
  \center
  \includegraphics [scale=0.5] {MHL_TestFuction_ParaboloidOfRevolution_Graph}
  \caption{Эллиптический параболоид} 
  \label{TestFunctions:img:MHL_TestFuction_ParaboloidOfRevolution_Graph}  
\end{figure}
