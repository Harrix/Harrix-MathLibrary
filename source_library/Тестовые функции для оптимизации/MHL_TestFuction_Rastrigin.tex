...
\textbf{График:} & Рисунок \ref{TestFunctions:img:MHL_TestFuction_Rastrigin_Graph} нас \pageref{TestFunctions:img:MHL_TestFuction_Rastrigin_Graph} стр.   \\
\end{tabularwide}

\begin{figure} [h] 
  \center
  \includegraphics [scale=0.5] {MHL_TestFuction_Rastrigin_Graph}
  \caption{Функция Растригина} 
  \label{TestFunctions:img:MHL_TestFuction_Rastrigin_Graph}  
\end{figure}
