...
\textbf{График:} & Рисунок \ref{TestFunctions:img:MHL_TestFunction_AckleyII_Graph} нас \pageref{TestFunctions:img:MHL_TestFunction_AckleyII_Graph} стр.   \\
\end{tabularwide}

\begin{figure} [h] 
  \center
  \includegraphics [scale=0.5] {MHL_TestFunction_AckleyII_Graph}
  \caption{Функция AckleyII} 
  \label{TestFunctions:img:MHL_TestFunction_AckleyII_Graph}  
\end{figure}
