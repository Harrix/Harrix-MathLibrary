...
\subsection{Подключение к Qt на примере Qt 5.3.0}

Рассматривается на примере создания Qt Gui Application в Qt 5.3.0 for Desktop (MinGW 4.8) с использованием Qt Creator 2.8.84.
