...
\title{MakeHarrixMathLibrary v.2.3}
...
\item \textbf{utf8gost71u.bst} --- файл оформления справки;
...
\item \textbf{Random.cpp} --- две основные функции для работы со случайными числами: HML\_SeedRandom() и HML\_RandomNumber();
\item \textbf{Random.h} --- объявлениях этих самых функций: HML\_SeedRandom() и HML\_RandomNumber();
